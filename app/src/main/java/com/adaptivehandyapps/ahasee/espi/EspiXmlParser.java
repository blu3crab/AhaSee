...
public class EspiXmlParser {
    ...
    /////////////////////////////////////////////////////////////////////////////////
    // constructor: callback enables progress bar updates
    private FeedManager.OnProgressCallback mCallback = null; //call back interface
    public EspiXmlParser(FeedManager.OnProgressCallback callback) {
        mCallback = callback;
    }
    // parse controller
