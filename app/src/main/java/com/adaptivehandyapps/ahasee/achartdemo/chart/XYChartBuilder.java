 ...
 */
package com.adaptivehandyapps.ahasee.achartdemo.chart;
...
public class XYChartBuilder extends Activity {
  ...
  private static final float LABEL_TEXT_SIZE = 15;
  private static final float LEGEND_TEXT_SIZE = 20;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mRenderer.setLabelsTextSize(LEGEND_TEXT_SIZE);
