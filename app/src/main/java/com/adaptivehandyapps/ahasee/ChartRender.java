...
public class ChartRender extends AbstractDemoChart {
    ...
    public static final float LABEL_TEXT_SIZE = 14f;
    public static final float CHART_VALUES_TEXT_SIZE = 16f;
    public static final float LEGEND_TEXT_SIZE = 24;

    public static final Boolean SHOW_ZOOM_BUTTONS = false;
...
//        int chartLayoutY = 512;
    ...
    public void openChart(boolean showLabels, ChartType chartType, int chartLayoutX, int chartLayoutY) {
        ...
        multiRenderer.setZoomButtonsVisible(SHOW_ZOOM_BUTTONS);
...
//        int roll = 4; // GMT-4
        ...
        multiRenderer.setLabelsTextSize(LABEL_TEXT_SIZE);
        multiRenderer.setLegendTextSize(LEGEND_TEXT_SIZE);
        multiRenderer.setChartValuesTextSize(CHART_VALUES_TEXT_SIZE);
...
//            seriesRenderer.setColor(colors[i]);
        ...
        defaultRenderer.setZoomButtonsVisible(SHOW_ZOOM_BUTTONS);
        defaultRenderer.setLabelsTextSize(LABEL_TEXT_SIZE);
        defaultRenderer.setLegendTextSize(LEGEND_TEXT_SIZE);
...
//            seriesRenderer.setChartValuesTextSize(10f);
            seriesRenderer.setChartValuesTextSize(CHART_VALUES_TEXT_SIZE);
        }
